...
import { loginUser, registerNewUser } from '../../services/userService'; // dostosuj ścieżkę
...
const AuthScreen = () => {
  ...
  // LOGIKA OBSŁUGI - TERAZ JEST BARDZO CZYSTA!
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Mapowanie błędów (w tym naszego niestandardowego USERNAME_TAKEN)
...
// ... (Twoje niezmienione style na dole)
const styles = StyleSheet.create({
  ...
  mainTitle: { fontSize: 42, fontWeight: '400', marginTop: 40, marginBottom: 40, color: '#000', textAlign: 'center' },
  formContainer: { width: width * 0.85 },
  inputWrapper: { backgroundColor: '#FFF', flexDirection: 'row', alignItems: 'center', borderRadius: 25, marginBottom: 20, paddingHorizontal: 10, paddingVertical: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.08, shadowRadius: 10, elevation: 5 },
  iconContainer: { backgroundColor: '#E99664', padding: 10, borderRadius: 15, marginRight: 15 },
  input: { flex: 1, fontSize: 18, color: '#000', paddingVertical: 10 },
  errorBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFEBEE', paddingVertical: 10, paddingHorizontal: 15, borderRadius: 15, marginTop: 5, marginBottom: 10 },
  errorText: { color: '#D32F2F', fontSize: 14, fontWeight: '500', marginLeft: 10, flex: 1 },
  ...
  switchText: { fontSize: 16, color: '#707070' },
